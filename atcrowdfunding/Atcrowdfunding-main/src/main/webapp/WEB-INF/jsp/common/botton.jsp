...
<li class="list-group-item">
    ...
    <ul style="margin-top:10px;">
        ...
        <li style="height:30px;">
            <a href="${pageContext.request.contextPath}/role/toIndex.htm"><i class="glyphicon glyphicon-certificate"></i> 角色维护</a>
        </li>
        <li style="height:30px;">
            <a href="${pageContext.request.contextPath}/permission/toIndex.htm"><i class="glyphicon glyphicon-lock"></i> 许可维护</a>
        </li>
    </ul>
</li>
<li class="list-group-item tree-closed">
