				...
				<form>
				  ...
				  <c:forEach items="${certimgs }" var="map">				  
					  <div class="form-group">
						...
						<img src="${pageContext.request.contextPath }/pics/cert/${map.iconpath}">
					  </div>
				  </c:forEach>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath }/jquery/layer/layer.js"></script>
        ...
        <script type="text/javascript">
            ...
            $("#passBtn").click(function(){
            	$.ajax({
            		type : "POST",
            		url  : "${pageContext.request.contextPath}/authcert/pass.do",
            		data : {
            			taskid : "${param.taskid}",
            			memberid : "${param.memberid}"
            		},
            		success : function(result) {
            			window.location.href = "${pageContext.request.contextPath}/authcert/index.htm";
            		}
            	});
            });
            ...
            $("#refuseBtn").click(function(){
            	$.ajax({
            		type : "POST",
            		url  : "${pageContext.request.contextPath}/authcert/refuse.do",
            		data : {
            			taskid : "${param.taskid}",
            			memberid : "${param.memberid}"
            		},
