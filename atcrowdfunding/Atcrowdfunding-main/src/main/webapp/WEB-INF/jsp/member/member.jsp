                        ...
                        <div class="caption" style="text-align:center;">
                            ...
                            <div class="caption" style="text-align:center;">
                                ...
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        <span class="label label-danger" style="cursor:pointer;" onclick="window.location.href='${pageContext.request.contextPath}/member/apply.do'">未实名认证</span>
                                    </c:otherwise>
                                </c:choose>
                            </div>
                        </div>
