...
<div class="container theme-showcase" role="main">
    ...
    <form role="form" id="uploadCertForm" method="post" enctype="multipart/form-data" style="margin-top:20px;">
        <c:forEach items="${queryCertByAccttype}" var="cert" varStatus="status">
            <div class="form-group">
                ...
                <input type="file" id="name" name="certimgs[${status.index}].fileImg" class="form-control" >
                <br>
    ...
    $("#nextBtn").click(function(){
        ...
        var options = {
            ...
            success : function(result) {
                ...
                if ( result.success ) {
                    layer.msg("数据保存成功", {time:1000, icon:6}, function(){
