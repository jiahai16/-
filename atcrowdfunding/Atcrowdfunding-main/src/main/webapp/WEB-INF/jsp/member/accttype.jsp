...
<div class="container theme-showcase" role="main">
    ...
    <script>
        ...
        $.each($(".thumbnail img"),function (i,n) {
            $(this).attr("src","${pageContext.request.contextPath}/"+$(this).attr("src"));
        });
        ...
        $("#applyBtn").click(function(){
            ...
            if ( len == 0 ) {
                ...
                $.ajax({
                    type : "POST",
                    url  : "${pageContext.request.contextPath}/member/updateAcctType.do",  //更新账户的类型
                    data : {
                        accttype : accttype
                    },
                    success : function(result) {
                        if ( result.success ) {
                            window.location.href = "${pageContext.request.contextPath}/member/basicinfo.htm";
                        } else {
